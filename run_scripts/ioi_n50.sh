...
WANDB_MODE=disabled python src/prune/fpt2_ioi.py \
    ...
    --output_dir ./data/runs/ioi-n50-${TAG}-elr${ELR}-llr${LLR}-relr${RELR}-rllr${RLLR}-es${EDGE_SPARSITY}-ns${NODE_SPARSITY}-t${TOTAL}/ \
