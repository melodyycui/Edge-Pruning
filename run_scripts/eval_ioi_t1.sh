for dir in /scratch/network/mc3803/Edge-Pruning/data/runs/ioi_t1-wo_node_loss-*/; do
    sbatch --partition=gpu --gres=gpu:1 --mem=30G --time=00:30:00 --constraint=gpu80 \
        --job-name=eval_ioi_t1 \
        --output=/scratch/network/mc3803/Edge-Pruning/joblog/eval_ioi_t1_$(basename $dir).out \
