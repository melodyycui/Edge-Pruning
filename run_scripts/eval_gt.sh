for dir in /scratch/network/mc3803/Edge-Pruning/data/runs/gt-wo_node_loss*/; do
    sbatch --partition=gpu --gres=gpu:1 --mem=30G --time=00:30:00 --constraint=gpu80 \
        --job-name=eval_gt \
        --output=/scratch/network/mc3803/Edge-Pruning/joblog/eval_gt_$(basename $dir).out \
